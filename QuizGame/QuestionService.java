...
System.out.println("Options:");
                ...
                System.out.println("Enter your answer: (Enter the option number only)");
...
if((userAnswer==1 && q.getO1().equals(q.getAnswer())) ||
   (userAnswer==2 && q.getO2().equals(q.getAnswer())) ||
   (userAnswer==3 && q.getO3().equals(q.getAnswer())) ||
   (userAnswer==4 && q.getO4().equals(q.getAnswer()))){
       c++;
   }
         }
}
